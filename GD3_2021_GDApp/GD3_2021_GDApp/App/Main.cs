...
namespace GDApp
{
    public class Main : Game
    {
        ...
        private void LoadTextures()
        {
            ...
            textureDictionary.Add("HP Bar V2", Content.Load<Texture2D>("Assets/Textures/UI/Controls/HP Bar V2"));
            ...
            textureDictionary.Add("keyboard", Content.Load<Texture2D>("Assets/Textures/UI/Backgrounds/Keyboard"));
        ...
        private void InitializeGameMenu()
        {
            ...
            UIObject controlmenuObject = null;
            #region Main Menu
            ...
            /************************** Controls Menu Scene **************************/
            //var controlMenuUIScene = new UIScene(AppData.MENU_CONTROLS_NAME);

            //texture = textureDictionary["keyboard"];
            //get how much we need to scale background to fit screen, then downsizes a little so we can see game behind background
            //scale = _graphics.GetScaleForTexture(texture, new Vector2(1f, 1f));

//            controlmenuObject = new UITextureObject("Keyboard",
  //              UIObjectType.Texture,
    //            new Transform2D(Screen.Instance.ScreenCentre, scale, 0), //sets position as center of screen
      //          0,
        //        new Color(500, 500, 500, 400),
          //      texture.GetOriginAtCenter(), //if we want to position image on screen center then we need to set origin as texture center
            //    texture);
            //controlMenuUIScene.Add(controlmenuObject);
           ...
           // uiMenuManager.SetActiveScene(AppData.MENU_CONTROLS_NAME);
        }
        ...
        private void InitializeGameUI()
        {
            ...
            var texture = textureDictionary["HP Bar V2"];
