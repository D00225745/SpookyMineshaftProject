...
namespace GDApp
{
    public class Main : Game
    {
        ...
        private void LoadSounds()
        {
            ...
            // MineWhispers Sound !!!!!!!!!!!!!!!!!!!
            soundManager.Add(new GDLibrary.Managers.Cue("MineWhispers",
            ...
            soundManager.Add(new GDLibrary.Managers.Cue("FlashlightFlickOff",
                Content.Load<SoundEffect>("Assets/Sounds/Effects/FlashlightFlickOff"),
                SoundCategoryType.Alarm, new Vector3(1, 0, 0), false));
            ...
            soundManager.Add(new GDLibrary.Managers.Cue("InventoryMap",
                Content.Load<SoundEffect>("Assets/Sounds/Effects/InventoryMap"),
                SoundCategoryType.Alarm, new Vector3(1, 0, 0), false));
